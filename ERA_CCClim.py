...
if __name__=="__main__":
    ...
    if not os.path.exists(os.path.join(scratch,"ERA5.parquet")):
        ...
        compare = compare_era(  era_df, "month")
        pool=Pool(10)
        ...
        joints_land.to_parquet(os.path.join(scratch,"reanalysis_land.parquet"))
        ...
        joints_ocean.to_parquet(os.path.join(scratch,"reanalysis_ocean.parquet"))
